...
if ($node) {
    switch ($modx->getOption('manager_language')) {
        case 'ru':
            $output .= '<label><input type="checkbox" name="update_node" value="true"> Обновить Node.JS локально</label>';
            break;
        default:
            $output .= '<label><input type="checkbox" name="update_node" value="true"> Update Node.JS locally</label>';
    }
}
