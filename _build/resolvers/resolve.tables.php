...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('modgulp_core_path', null,
                    $modx->getOption('core_path') . 'components/modgulp/') . 'model/';
            $modx->addPackage('modgulp', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/modgulp/model/schema/modgulp.mysql.schema.xml';
